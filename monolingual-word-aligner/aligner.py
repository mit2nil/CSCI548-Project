...
def align(sentence1, sentence2):
    ...
    #print len(sentence1ParseResult['sentences'][0]['words'])
    #print len(sentence2ParseResult['sentences'][0]['words'])

    #print sentence1ParseResult
    #print sentence2ParseResult
    ...
    ### The return object is modified to return the list of words from both sentences###
    return [myWordAlignments, myWordAlignmentTokens,
             [i[0] for i in sentence1ParseResult['sentences'][0]['words']],
             [i[0] for i in sentence2ParseResult['sentences'][0]['words']]]
    ### The return object is modified to return the list of words from both sentences###
##############################################################################################################################

...
def get_alignment_score(sentence_pair):
	try:
		...
		alignment = align(re.sub("[#(){}:]+","",sentence_pair[0]).decode("utf-8").encode("ascii","ignore"), re.sub("[#(){}:]+","",sentence_pair[1]).decode("utf-8").encode("ascii","ignore"))
...
if __name__ == "__main__": 
	training_sentences, gold_standard_scores = read_training_data("c5")
